...
echo ""
echo "  3. Para cada artefato, o papel humano correspondente abre uma"
echo "     sessão de assistente de IA (ex.: 'claude' para Claude Code)"
echo "     e supervisiona a produção. A ordem do fluxo de quatro etapas"
echo "     é inviolável; antes de qualquer linha de código, produza:"
echo ""
echo "       docs/GOAL.md          ← etapa 1 — objetivo (engenheiro)"
echo "       docs/BUSINESS.md      ← etapa 2 — problema (analista)"
echo "       docs/GUIDELINE.md     ┐"
echo "       docs/ARCHITECTURE.md  ├ etapa 3 (paralela) — projeção (designer + arquiteto)"
echo "       docs/SOLUTION.md      ┘"
echo "                             → etapa 4 — implementação em src/ e test/ (engenheiro)"
echo ""
