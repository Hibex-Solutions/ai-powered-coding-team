...
Use como base o template `.claude/skills/dotnetblazor-engineer/templates/component.csproj` para camadas de negócio.
Para o projeto Blazor (`UI.WebApp`), use `.claude/skills/dotnetblazor-engineer/templates/app.blazor.csproj`.
...
- Enterprise: `.claude/skills/dotnetblazor-engineer/templates/AssemblyInfo.enterprise.cs`
- Application: `.claude/skills/dotnetblazor-engineer/templates/AssemblyInfo.application.cs`
- InterfaceAdapter: `.claude/skills/dotnetblazor-engineer/templates/AssemblyInfo.interfaceadapter.cs`
...
- Camadas de negócio (Entities e UseCases): `.claude/skills/dotnetblazor-engineer/templates/Usings.business.cs`
- Blazor Web App (`UI.WebApp`): `.claude/skills/dotnetblazor-engineer/templates/Usings.webapp.cs`

---

## `Directory.Build.props` (raiz da solução)

Use como base o template `.claude/skills/dotnetblazor-engineer/templates/Directory.Build.props`.
...
Use o template `.claude/skills/dotnetblazor-engineer/templates/Usings.tests.cs`.

### `.csproj` de teste
Use como base o template `.claude/skills/dotnetblazor-engineer/templates/test.csproj`.
...
Use o template `.claude/skills/dotnetblazor-engineer/templates/global.json`.
...
Ao criar uma solução nova do zero, leia `.claude/skills/dotnetblazor-engineer/creation-sequence.md` para obter a sequência completa de passos com os comandos necessários.
